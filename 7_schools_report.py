...
for school in schools:
    if school['NCAA']["NAIA conference number football (IC2020)"] in conference_schools:
        if school["Graduation rate  women (DRVGR2020)"] > 80:
            print('University Name:', school["instnm"])
            print('Graduation Rate Woman:', school["Graduation rate  women (DRVGR2020)"])
            print()
...
for school in schools:
    if school['NCAA']["NAIA conference number football (IC2020)"] in conference_schools:
        if school["Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)"] > 50000:
                print('University Name:', school["instnm"])
                print('Total price for in-state students living off campus:', school["Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)"])
                print()